...
def render_timeline_svg(data: list[dict], height: int = 100) -> str:
    ...
    return f'''<svg viewBox="0 0 {svg_w} {svg_h}" style="width:100%;max-width:800px;display:block;background:#161b22;border-radius:8px;margin-bottom:0.5rem;">
